# ⚡ ESP32 Pharmaceutical Cleanroom Dual-Door Airlock Interlock System
...
GMP cleanroom safety controller enforcing anti-passback interlocking between dual magnetic doors, differential room pressure validation, and UV-C sterilization.
...
3. Pastikan dependensi pustaka terpasang:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-cleanroom-airlock-interlock.ino`](./esp32-cleanroom-airlock-interlock.ino).
