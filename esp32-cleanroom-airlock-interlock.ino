/**
 * =========================================================================================
 * Project     : ESP32 Pharmaceutical Cleanroom Dual-Door Airlock Interlock System
 * Platform    : ESP32 (Dual-Core Xtensa LX6 / FreeRTOS)
 * Framework   : Arduino IDE 2.0+
 * Author      : Muhammad Fikri
 * License     : MIT
 * Description : GMP cleanroom safety controller enforcing anti-passback interlocking between dual magnetic doors, differential room pressure validation, and UV-C sterilization.
 * =========================================================================================
 */
...
void TaskTelemetryBroadcaster(void *pvParameters) {
    ...
    for (;;) {
        if (xSemaphoreTake(g_telemetryMutex, pdMS_TO_TICKS(20)) == pdTRUE) {
            ...
            doc["system"] = "esp32-cleanroom-airlock-interlock";
...
void setup() {
    ...
    Serial.println(F("================================================================="));
    Serial.println(F(" ESP32 Pharmaceutical Cleanroom Dual-Door Airlock Interlock System"));
